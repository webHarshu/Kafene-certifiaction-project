...
function createtr(usersData) {
    ...
    tr.innerHTML = `
        <td class="UserList-Secondary-Text ">${usersData.id}</td>
        <td class="UserList-Primary-Text">
            <img src="${usersData.profilePic}"
                alt="Profile Pic">
        </td>
        <td class="UserList-Secondary-Text ">${usersData.fullName}</td>
        <td class="UserList-Primary-Text">${usersData.dob}</td>
        <td class="UserList-Secondary-Text ">${usersData.gender}</td>
        <td class="UserList-Secondary-Text ">${usersData.currentCity}, ${usersData.currentCountry}</td>
        `
    return tr;
}
