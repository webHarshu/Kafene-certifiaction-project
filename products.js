...
function renderProductsData(productData) {
    ...
    for (let i = 0; i < productData.length; i++) {
        ...
        tr.classList.add('Homepage-Table-Row');
        tr.innerHTML = `
<td class="Homepage-Secondary-Text">${currentproductData.id}</td>
<td class="Homepage-Primary-Text ">${currentproductData.medicineName}</td>
<td class="Homepage-Primary-Text ">${currentproductData.medicineBrand}</td>
<td class="Homepage-Secondary-Text">$${currentproductData.expiryDate}</td>
<td class="Homepage-Primary-Text ">${currentproductData.unitPrice}</td>
<td class="Homepage-Primary-Text ">${currentproductData.stock}</td>
`
        tbody.append(tr);
    }
}
