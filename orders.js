...
function renderOrderData(orderData) {
    ...
    for (let i = 0; i < orderData.length; i++) {
        ...
        tr.innerHTML = `
<td class="Homepage-Secondary-Text">${currentorderData.id}</td>
<td class="Homepage-Primary-Text ">${currentorderData.customerName}</td>
<td class="Homepage-Primary-Text ">${currentorderData.orderDate}<br>
   <span class="Homepage-Secondary-Text">${currentorderData.orderTime}</span>
   </td>
<td class="Homepage-Secondary-Text">$${currentorderData.amount}</td>
 <td class="Homepage-Primary-Text">${currentorderData.orderStatus}</td>
`
        tbody.append(tr);
